...
export default function SpørsmålBody({
  ...
  if (!spørreundersøkelse) {
    return <BodyShort>Kunne ikke hente spørsmål</BodyShort>;
  }

  const byttSpørsmål = (nesteindeks: number) => {
    if (nesteindeks === spørreundersøkelse.length || nesteindeks < 0) {
    ...
    >
      ...
      <Page.Block as={"main"}>
        ...
        <VStack gap="4" align={"center"}>
          ...
          <BodyShort size={"large"} spacing className={spørsmålStyles.innhold}>
