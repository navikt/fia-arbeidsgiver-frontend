...
function Sykefraværsarbeid() {
  return (
    <Box borderRadius="xlarge" padding="10" background="surface-success-subtle">
      ...
      <List as="ul">
        ...
        <ListItem>
          At ansatte vet hva som forventes når en er sykmeldt eller står i fare
          for å bli det.
        </ListItem>
      </List>
    </Box>
...
function Arbeidsmiljø() {
  return (
    <Box borderRadius="xlarge" padding="10" background="surface-warning-subtle">
      <List as="ul">
        <ListItem>
        ...
        <ListItem>
          Psykologiske og sosiale forhold på arbeidsplassen er viktige faktorer
          for arbeidsmiljøet.
        </ListItem>
        <ListItem>
